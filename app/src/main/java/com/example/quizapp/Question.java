...
public class Question{
    ...
    public Question(){}
    public Question(String question, String option1, String option2, String option3, int ansNumber,String subject) {
    ...
    public static String[] getAllSubject(){
        return new String[]{SUBJECT_MATHS,SUBJECT_HISTORY};
    }
}
